...
client.on(Discord.Events.GuildMemberAdd, async (member) => {
    ...
    if (welcomeChannel?.type == Discord.ChannelType.GuildText)
        welcomeChannel.send(`Welcome to ${member.guild.name} ${member}, glad you made it here safely! Make sure to grab some <#926505179514273863> and <#1063518630261825597> and then come join us in <#926461127100100608>`)
})
